...
<body>
    ...
    <div class="Portada">
        <img src="Portada Web.png" alt="Portada">
    </div>

    <div>
        <h1> Curriculum vitae Edgar Cáceres Olmedo</h1>
        ...
        <div class="Datos_personales">
            ...
            <ul>
                ...
                <li>Email : <a href="edgar.caceres1991@gmail.com" target="_blank">edgar.caceres1991@gmail.com</a></li>
        ...
        <div class="Experiencia">
            ...
            <dl>
                ...
                <dd><em><strong>Cliente Asignado: </strong></em><br> <!-- em Texto en Cursiva / strong Texto en Negrita-->
            ...
            <dl>
                ...
                <dd class="Rol">Tutor Data Analytics, SQL, Tableau, Power BI, Python, Business Analytics | Julio 2021 -
                    Presente</dd>
            ...
            <dl>
                ...
                <dd><em><strong>Clientes Asignados: </strong></em><br>
                    Lartirigoyen, Transener, Arauco Argentina, Abbvie LATAM, DIA Argentina, y CNP Seguros (Argentina)
                    <br>
                    <em><strong>Tareas: </strong></em><br>
